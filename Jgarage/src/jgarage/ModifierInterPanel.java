 ...
 * @author Utilisateur
 */
public class ModifierInterPanel extends JPanel implements ActionListener{
    ...
    private JButton bt_modif_inter = new JButton("Enregistrer modification");
    
    public ModifierInterPanel(Fenetre f)
    {
        frame_mere = f; 
